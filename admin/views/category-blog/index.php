...
echo Button::widget([
    ...
    'options' => [
        ...
        'href' => Url::toRoute(['category-blog/update'])
    ],
]);
...
echo GridView::widget([
    ...
    'columns' => [
        ...
        [
            ...
            'value' => function ($model) {
                return Html::label($model->is_work ? "Work" : "Blog", '', ['class' => 'label label-' . ($model->is_work ? 'primary' : 'success'), 'style' => 'width: 45px; display: inline-block;']);
            },
        ...
        [
            ...
            'filter' => false,
            'value' => function ($model) {
                return Html::label($model->order, '', ['class' => 'label label-default', 'style' => 'width: 45px; display: inline-block;']);
            },
        ...
        [
            ...
            'content' => function ($model) {
                ...
                $buttons = Button::widget([
                    ...
                    'options' => [
                        'class' => 'btn-primary',
                        'href' => Url::toRoute(['category-blog/update', 'id' => $model->id])
                    ],
                ]);
                ...
                $buttons .= Button::widget([
                    ...
                    'options' => [
                        ...
                        'onclick' => 'if (confirm("Delete this model?")) window.location.href = "'
                            . Url::toRoute(['category-blog/delete', 'id' => $model->id]) . '"'
                    ],
                ]);
